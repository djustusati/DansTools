<%@ Page Title="Bullhorn Search" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterPages/masterA.Master" CodeBehind="BullhornLookup.aspx.vb" Inherits="DansTools.MetrixStuff.BullhornLookup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div>
		...
		<asp:SqlDataSource ID="BullhornDB" runat="server" ConnectionString="<%$ ConnectionStrings:BullhornCustom %>" SelectCommand="SELECT GMREmployeeID, FullName, firstName, middleName, lastName, address1, address2, city, state, zip, EmailAddress, PhoneNumber1, PhoneNumber2, ProgramNumber, Region, AssignmentStatus, StartDate1, EndDate1, title, EmployeeStatus, gender, HireType, LastUpdate, placementID, userID, jobOrderID, ALTRIAID
FROM [Placements]
WHERE (@FirstName = ' '
	...
	AND (EndDate1 > '1/1/2015')
ORDER BY lastName, firstName, GMREmployeeID, StartDate1">
			<SelectParameters>
