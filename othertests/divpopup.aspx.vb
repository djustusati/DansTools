Public Partial Class divpopup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            btnUpdateMenu.Attributes.Add("onClick", "document.all['divUpdatePopup'].style.visibility='hidden';")
            'use the code below to disable editing of the menu id field in the popup div
            txtEditMenuID.Attributes.Add("onKeyPress", "javascript:return false;")
        End If
    End Sub
