...
Partial Public Class RecapVoucher
    Public Property Id As Integer
    Public Property RecapId As Integer
    Public Property DistributedVouchers As Nullable(Of Integer)
    Public Property RedeemedDuringPromo As Nullable(Of Integer)
    Public Property RedeemedPostPromo As Nullable(Of Integer)
