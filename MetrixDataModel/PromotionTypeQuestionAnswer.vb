...
Partial Public Class PromotionTypeQuestionAnswer
    Public Property Id As Integer
    Public Property PromotionTypeQuestionId As Integer
    ...
    Public Overridable Property PromotionTypeQuestion As PromotionTypeQuestion
