...
Partial Public Class TaskDefinition
    ...
    Public Overridable Property TaskStepDefinition As ICollection(Of TaskStepDefinition) = New HashSet(Of TaskStepDefinition)
