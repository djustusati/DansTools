...
Partial Public Class PhysicalCountFrequency
    ...
    Public Overridable Property PhysicalCountSchedule As ICollection(Of PhysicalCountSchedule) = New HashSet(Of PhysicalCountSchedule)
