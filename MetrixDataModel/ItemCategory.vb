...
Partial Public Class ItemCategory
    ...
    Public Overridable Property ItemCategory1 As ICollection(Of ItemCategory) = New HashSet(Of ItemCategory)
    Public Overridable Property ItemCategory2 As ItemCategory
