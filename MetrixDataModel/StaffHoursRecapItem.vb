...
Partial Public Class StaffHoursRecapItem
    Public Property Id As Integer
    Public Property StaffHoursRecapId As Integer
    Public Property StaffHoursRecapType As Integer
    ...
    Public Overridable Property StaffHoursRecap As StaffHoursRecap
